    ...
    <div id="container" class="clear">
      ...
      <form action="codeteacherprofile.jsp" method="post">
          ...
          <table align="center" border="0px" width="100px">
              ...
              <tr >
                  <td>Full Name:</td><td><input type="text" name="fullname" size="54px"/></td>
              </tr>
             
              <tr >
                  <td>Age:</td><td><input type="text" name="age" size="54px"/></td>
              </tr>
              ...
              <tr >
                  <td>Contact No:</td><td><input type="text" name="contactno" size="54px"/></td>
              </tr>
                            
              <tr >
                  <td>Address:</td><td><textarea cols="52" rows="6" name="address"></textarea></td>
              </tr>
             ...
             <tr >
              ...
              <tr >
                  <td>Grade:</td><td><input type="text" name="grade" size="54px"/></td>
              </tr>
