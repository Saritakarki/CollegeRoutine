                        ...
                        try
                        {
                             ...
                             if ((request.getParameter("index") != null) && (!(request.getParameter("index").trim().equals("")))) 
                             {
                                ...
                                {          
                                  ...
                                  <tr >
                                      <td>Address:</td><td><textarea cols="52" rows="6" name="address"><%=rs11.getString(5)%></textarea></td>
                                  </tr>
                                 ...
                                 <tr >
                                  ...
                                  <tr >
                                      <td>Grade:</td><td><input type="text" name="grade" value="<%=rs11.getString("Grade")%>" size="54px"/></td>
                                  </tr>
